    ...
    Public Sub Login(value As String)
        ...
        Try
            ...
            If ds.Tables("WUSER").Rows.Count > 0 Then
                ...
                Dim UserCode As String = dr("UserName").ToString.Trim().ToUpper
                Dim passwrod As String = dr("PassWord").ToString.Trim()

                SQLStr = String.Format("SELECT * FROM users where email = {0} and password = {1} and active=1", UserCode, passwrod)
        ...
        Try
            ...
            If ds.Tables("SUID").Rows.Count > 0 Then
                ...
                Else
                    Throw New Exception("No Surveyor ID Mapping Found for this user")
                End If
                SQLStr = "SELECT T1.""U_SCode"", T1.""U_SName"" FROM  ""@SURVEYORID""  T0 , ""ICSB_DEV"".""@SURVEYORIDL""  T1 WHERE T1.""Code"" = T0.""Code"" and  T0.""Code"" ='" & CompCode & "'"
                SQLDT = fn.ExecuteSQLQuery(SQLStr, sErrDesc)
                If sErrDesc <> "" Then
                    Throw New Exception(sErrDesc)
                ElseIf SQLDT.Rows.Count = 0 Then
...
<ScriptMethod(ResponseFormat:=ResponseFormat.Json)> _
    Public Sub SurveyorIDMaster_full()
        ...
        Try
            ...
            '    Throw New Exception("No Surveyor ID Mapping Found for this user")
            'End If
            SQLStr = "SELECT T1.""U_SCode"", T1.""U_SName"" FROM  ""@SURVEYORID""  T0 , ""ICSB_DEV"".""@SURVEYORIDL""  T1 WHERE T1.""Code"" = T0.""Code"""
            SQLDT = fn.ExecuteSQLQuery(SQLStr, sErrDesc)
            If sErrDesc <> "" Then
                Throw New Exception(sErrDesc)
            ElseIf SQLDT.Rows.Count = 0 Then
...
<ScriptMethod(ResponseFormat:=ResponseFormat.Json)> _
    Public Sub Survey_Criteria_Master()
        Try
            ...
            Dim RetDS As New DataSet
            Dim Str As String = "SELECT T0.""U_SURCRTACODE"", T0.""U_SURCRTANAME"" FROM ""ICSB_DEV"".""@SUCRITERIA""  T0"
            Dim RetDT As New DataTable
            Dim RetDT1 As New DataTable
...
<ScriptMethod(ResponseFormat:=ResponseFormat.Json)> _
    Public Sub Equipment_Type_Master()
        Try
            ...
            Dim RetDS As New DataSet
            Dim Str As String = "SELECT T0.""U_EQTYPECODE"",T0.""U_EQTYPENAME"" FROM ""ICSB_DEV"".""@EQTYPE""  T0"
            Dim RetDT As New DataTable
            Dim RetDT1 As New DataTable
...
<ScriptMethod(ResponseFormat:=ResponseFormat.Json)> _
    Public Sub Surveyor_Ex_Agent()
        Try
            ...
            Dim RetDS As New DataSet
            Dim Str As String = "SELECT T0.""U_ANAME"" FROM ""ICSB_DEV"".""@SUEXAGENT""  T0  ORDER BY T0.""U_ANAME"""
            Dim RetDT As New DataTable
            Dim RetDT1 As New DataTable
    ...
    Public Sub SalesOrderAdd(value As String)
        ...
        Try
            ...
            If ds.Tables("ORDR").Rows.Count > 0 Then
                SQTO = ds.Tables("ORDR")
                Dim dr As DataRow = SQTO.Rows(0)
                oSO.UserFields.Fields.Item("U_UCode").Value = dr.Item("U_UName").ToString.Trim() 'dr.Item("U_UCode").ToString.Trim()
...
"FROM ""ICSB_DEV"".""@CCON""  T0 " & _
"Left Join ""ICSB_DEV"".""@CCONGENERAL""  T1 ON T1.""DocEntry"" = T0.""DocEntry"" " & _
   ...
   <ScriptMethod(ResponseFormat:=ResponseFormat.Json)> _
    Public Sub SalesOrder_FirstRecord(value As String)
        ...
        Try
            ...
            Dim Query As String = "SELECT Top 1 T0.""DocEntry"" as ""U_OrderNo"", T0.""DocStatus"" as ""U_Status"", T0.""U_UCode"",T0.""U_UName"", TO_CHAR( T0.""U_Cdate"" , 'DD/MM/YYYY') As ""U_Cdate"", TO_CHAR( T0.""DocDate"" , 'DD/MM/YYYY') As ""DocDate"",  T0.""CardCode"",  T0.""CardName"", T0.""U_SurveyorID"", T0.""NumAtCard"",T0.""U_STypeCode"",  T0.""U_U_STypeName""  As  U_STypeName, T0.""U_Country"", T0.""U_City"", T0.""U_Loc"", T0.""Project"", T0.""Comments"" FROM ORDR T0 where T0.""U_UCode"" in (SELECT T0.""Code"" FROM ""ICSB_DEV"".""@WUSER""  T0 WHERE T0.""U_ComCode""  ='" & CompCode & "') ORDER BY T0.""DocEntry"" ASC"
            Dim ErrMsg As String = ""
            Dim RetDT As New DataTable
            Dim RetDT1 As New DataTable
            Dim RetDT2 As New DataTable
            ...
            If RetDT.Rows.Count > 0 Then
                ...
                Query = "SELECT T1.""Quantity"", TO_CHAR( T1.""U_PDate"" , 'DD/MM/YYYY') ""U_PDate"", T1.""U_EQType"", T1.""U_SCriteria"", T1.""LineStatus"", T1.""OpenQty"" FROM ""ICSB_DEV"".""RDR1""  T1 WHERE T1.""DocEntry"" ='" & DocEntry & "'"
                RetDT = fn.ExecuteSQLQuery(Query, ErrMsg)
                If ErrMsg <> "" Then
                    Throw New Exception(ErrMsg)
                End If
    ...
    Public Sub SalesOrder_PreviousRecord(value As String)
        ...
        Try
            ...
            If ds.Tables("ORDR").Rows.Count > 0 Then
                ...
                Else
                    'Query = "SELECT Top 1 T0.""DocEntry"" As ""U_Qno"", T0.""U_Status"", T0.""U_Uname"",TO_CHAR( T0.""U_Cdate"" , 'DD/MM/YYYY') As ""U_Cdate"",  T0.""U_Ccode"", T0.""U_Cname"", TO_CHAR( T0.""U_CPeriod1"" , 'DD/MM/YYYY') As ""U_CPeriod1"", TO_CHAR( T0.""U_CPeriod2"" , 'DD/MM/YYYY') As ""U_CPeriod2"", T0.""U_Pcode"", T0.""U_AddrN"", T0.""U_Addr1"", T0.""U_Addr2"", T0.""U_Addr3"", T0.""U_Addr4"", T0.""U_Addr5"", T0.""U_Addr6"", T0.""U_TelNo"", T0.""U_FaxNo"", T0.""U_Mno"", T0.""U_Email"", T0.""U_Remarks"" FROM ""@CCON"" T0  where T0.""DocEntry"" =(SELECT (T0.""DocEntry"" - 1)  ""DocEntry"" FROM ""@CCON""  T0 WHERE T0.""DocNum"" ='" & DocNum & "')"
                    Query = "SELECT Top 1 T0.""DocEntry"" as ""U_OrderNo"", T0.""DocStatus"" as ""U_Status"", T0.""U_UCode"",T0.""U_UName"", TO_CHAR( T0.""U_Cdate"" , 'DD/MM/YYYY') As ""U_Cdate"", TO_CHAR( T0.""DocDate"" , 'DD/MM/YYYY') As ""DocDate"",  T0.""CardCode"",  T0.""CardName"", T0.""U_SurveyorID"", T0.""NumAtCard"",T0.""U_STypeCode"",  T0.""U_U_STypeName""  As  U_STypeName, T0.""U_Country"", T0.""U_City"", T0.""U_Loc"", T0.""Project"", T0.""Comments"" FROM ORDR T0 where T0.""DocEntry"" = (SELECT	Top 1 ifnull(T0.""DocEntry"",0) ""DocEntry"" FROM ORDR T0 where T0.""U_UCode"" in (SELECT	 T0.""Code"" 	FROM ""ICSB_DEV"".""@WUSER"" T0 WHERE T0.""U_ComCode"" ='" & CompCode & "' ) and  T0.""DocEntry""<'" & DocNum & "' ORDER BY T0.""DocEntry"" DESC)"
                End If
                Dim RetDT As New DataTable
                Dim RetDT1 As New DataTable
                Dim RetDT2 As New DataTable
    ...
    Public Sub SalesOrder_NextRecord(value As String)
        ...
        Try
            ...
            If ds.Tables("ORDR").Rows.Count > 0 Then
                ...
                Else
                    'Query = "SELECT Top 1 T0.""DocEntry"" As ""U_Qno"", T0.""U_Status"", T0.""U_Uname"",TO_CHAR( T0.""U_Cdate"" , 'DD/MM/YYYY') As ""U_Cdate"",  T0.""U_Ccode"", T0.""U_Cname"", TO_CHAR( T0.""U_CPeriod1"" , 'DD/MM/YYYY') As ""U_CPeriod1"", TO_CHAR( T0.""U_CPeriod2"" , 'DD/MM/YYYY') As ""U_CPeriod2"", T0.""U_Pcode"", T0.""U_AddrN"", T0.""U_Addr1"", T0.""U_Addr2"", T0.""U_Addr3"", T0.""U_Addr4"", T0.""U_Addr5"", T0.""U_Addr6"", T0.""U_TelNo"", T0.""U_FaxNo"", T0.""U_Mno"", T0.""U_Email"", T0.""U_Remarks"" FROM ""@CCON"" T0  where T0.""DocEntry"" =(SELECT (T0.""DocEntry"" - 1)  ""DocEntry"" FROM ""@CCON""  T0 WHERE T0.""DocNum"" ='" & DocNum & "')"
                    Query = "SELECT Top 1 T0.""DocEntry"" as ""U_OrderNo"", T0.""DocStatus"" as ""U_Status"", T0.""U_UCode"",T0.""U_UName"", TO_CHAR( T0.""U_Cdate"" , 'DD/MM/YYYY') As ""U_Cdate"", TO_CHAR( T0.""DocDate"" , 'DD/MM/YYYY') As ""DocDate"",  T0.""CardCode"",  T0.""CardName"", T0.""U_SurveyorID"", T0.""NumAtCard"",T0.""U_STypeCode"",  T0.""U_U_STypeName""  As  U_STypeName, T0.""U_Country"", T0.""U_City"", T0.""U_Loc"", T0.""Project"", T0.""Comments"" FROM ORDR T0 where T0.""DocEntry"" = (SELECT	Top 1 ifnull(T0.""DocEntry"",0) ""DocEntry"" FROM ORDR T0 where T0.""U_UCode"" in (SELECT	 T0.""Code"" 	FROM ""ICSB_DEV"".""@WUSER"" T0 WHERE T0.""U_ComCode"" ='" & CompCode & "' ) and  T0.""DocEntry"">'" & DocNum & "' ORDER BY T0.""DocEntry"" ASC)"
                End If
                Dim RetDT As New DataTable
                Dim RetDT1 As New DataTable
                Dim RetDT2 As New DataTable
